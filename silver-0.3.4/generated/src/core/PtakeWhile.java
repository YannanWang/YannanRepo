...
public final class PtakeWhile extends common.FunctionNode {
	...
	public static common.ConsCell invoke(final Object[] args) {
		...
		//if null(lst) || ! f(head(lst)) then [] else (head(lst) :: takeWhile(f, tail(lst)))
		 return (common.ConsCell)(((((Boolean)core.Pnull.invoke(new Object[]{context.childAsIsLazy(core.PtakeWhile.i_lst)})) || (!((Boolean)((common.NodeFactory<Boolean>)context.childAsIs(core.PtakeWhile.i_f)).invoke(new Object[]{new common.Closure(context) { public final Object eval() { return ((Object)core.Phead.invoke(new Object[]{context.childAsIsLazy(core.PtakeWhile.i_lst)})); } }})))) ? ((common.ConsCell)core.Pnil.invoke(new Object[]{})) : ((common.ConsCell)core.Pcons.invoke(new Object[]{new common.Closure(context) { public final Object eval() { return ((Object)core.Phead.invoke(new Object[]{context.childAsIsLazy(core.PtakeWhile.i_lst)})); } }, new common.Closure(context) { public final Object eval() { return ((common.ConsCell)core.PtakeWhile.invoke(new Object[]{context.childAsIsLazy(core.PtakeWhile.i_f), new common.Closure(context) { public final Object eval() { return ((common.ConsCell)core.Ptail.invoke(new Object[]{context.childAsIsLazy(core.PtakeWhile.i_lst)})); } }})); } }}))));
