...
public final class Pfoldr extends common.FunctionNode {
	...
	public static Object invoke(final Object[] args) {
		...
		//if null(l) then i else f(head(l), foldr(f, i, tail(l)))
		 return (Object)((((Boolean)core.Pnull.invoke(new Object[]{context.childAsIsLazy(core.Pfoldr.i_l)})) ? ((Object)context.childAsIs(core.Pfoldr.i_i)) : ((Object)((common.NodeFactory<Object>)context.childAsIs(core.Pfoldr.i_f)).invoke(new Object[]{new common.Closure(context) { public final Object eval() { return ((Object)core.Phead.invoke(new Object[]{context.childAsIsLazy(core.Pfoldr.i_l)})); } }, new common.Closure(context) { public final Object eval() { return ((Object)core.Pfoldr.invoke(new Object[]{context.childAsIsLazy(core.Pfoldr.i_f), context.childAsIsLazy(core.Pfoldr.i_i), new common.Closure(context) { public final Object eval() { return ((common.ConsCell)core.Ptail.invoke(new Object[]{context.childAsIsLazy(core.Pfoldr.i_l)})); } }})); } }}))));
