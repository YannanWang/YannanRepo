...
public final class Pnothing extends core.NMaybe {
	...
	public Pnothing(final Object[] args) {
		super(args);
	}
	...
	static void initProductionAttributeDefinitions() {
		...
		core.Pnothing.synthesizedAttributes[core.Init.core_fromJust__ON__core_Maybe] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((Object)core.Perror.invoke(new Object[]{(new common.StringCatter("fromJust accessed on a Maybe that was actually nothing!"))})); } };
		// top.isJust = false
	...
	public static final class Factory extends common.NodeFactory<Pnothing> {
		...
		@Override
		public Pnothing invoke(final Object[] children) {
			return new Pnothing(children);
		}
