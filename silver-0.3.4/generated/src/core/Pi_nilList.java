...
public final class Pi_nilList extends core.NList {
	...
	public Pi_nilList(final Object[] args) {
		super(args);
	}
	...
	static void initProductionAttributeDefinitions() {
		...
		core.Pi_nilList.synthesizedAttributes[core.Init.core_i_headList__ON__core_List] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((Object)core.Perror.invoke(new Object[]{(new common.StringCatter("requested head of nil"))})); } };
		// l.i_tailList = error("requested tail of nil")
		core.Pi_nilList.synthesizedAttributes[core.Init.core_i_tailList__ON__core_List] = new common.Lazy() { public final Object eval(final common.DecoratedNode context) { return ((common.DecoratedNode)core.Perror.invoke(new Object[]{(new common.StringCatter("requested tail of nil"))})); } };
	}
	...
	public static final class Factory extends common.NodeFactory<Pi_nilList> {
		...
		@Override
		public Pi_nilList invoke(final Object[] children) {
			return new Pi_nilList(children);
		}
