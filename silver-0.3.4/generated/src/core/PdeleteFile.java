...
public final class PdeleteFile extends common.FunctionNode {
	...
	public PdeleteFile(final Object[] args) {
		super(args);
	}
	...
	public static core.NIOVal invoke(final Object[] args) {
		try {
		return (core.NIOVal)new core.Pioval(((Object)(args[i_i] = common.Util.demand(args[i_i]))), common.Util.deleteFile(((common.StringCatter)(args[i_s] = common.Util.demand(args[i_s]))).toString()));
		} catch(Throwable t) { throw new common.exceptions.TraceException("Error while evaluating function core:deleteFile", t); }
	}
	...
	public static final class Factory extends common.NodeFactory<core.NIOVal> {
		...
		public core.NIOVal invoke(final Object[] args) {
			return PdeleteFile.invoke(args);
		}
